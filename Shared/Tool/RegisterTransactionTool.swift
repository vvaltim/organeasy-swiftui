////
////  RegisterTransactionTool.swift
////  OrganEasy
////
////  Created by Walter Vânio dos Reis Júnior on 22/12/25.
////
//
//import Foundation
//import FoundationModels
//
//struct RegisterTransactionTool: Tool {
//    let name: String = "registerTransactionTool"
//    let description: String = "Extrai dados de uma Transação e salva no banco."
//    
